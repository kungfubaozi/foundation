...
var (
	...
	ErrTransfer        = &fs_base.State{Ok: false, Message: "err system data transfer", Code: 10027} //验证码错误
	ErrAlreadyBind     = &fs_base.State{Ok: false, Message: "err already bind", Code: 10028}         //验证码错误
)
